...
WebUI.setText(findTestObject('04 - Self-services/04.4 - Tickets/Page_Home page/input_TicketID'), '1000453')

WebUI.click(findTestObject('04 - Self-services/04.4 - Tickets/Page_Home page/btnSearch'))
